...
import Board, { IBoardProps, TimeType } from 'components/BoardChart/dataCenter';
...
const TopPanel = () => {
  ...
  by (node)) * (${craneDiscount}/100.0)`,
      ...
      tips: t('过去一个月所有集群总成本。从安装Crane时间开始，按小时累加集群成本'),
    },
    {
      title: t('所有集群预估每月成本'),
      countPrefix: '¥ ',
