import{R as _,a as i,e as l,k as r,j as a,C as s,f as u}from"./index.e999ac47.js";import{S as o}from"./index.d4686474.js";import"./useCraneUrl.91338662.js";import"./index.d57ce8fb.js";import"./DateRangePicker.128e9774.js";import"./index.f30be7d6.js";const c="_carbonChartPanel_19fe9_1";var b={carbonChartPanel:c};const p=()=>{const{t:n}=i(),e={title:n("\u80FD\u8017"),subTitle:n("(\u74E6\u7279/\u5C0F\u65F6)"),datePicker:!0,step:"1h",xAxis:{type:"time"},lines:[{name:n("energy consumption"),query:`((sum(label_replace(irate(container_cpu_usage_seconds_total{container!=""}[5m]), "node", "$1", "instance",  "(^[^:]+)") * on (node) group_left() max(kube_node_labels{label_beta_kubernetes_io_instance_type!~"eklet", label_node_kubernetes_io_instance_type!~"eklet"}) by (node))
/
