import{R as _,a as i,e as l,k as r,j as a,C as s,f as u}from"./index.3b561666.js";import{S as o}from"./index.355c09ff.js";import"./useCraneUrl.ac6187d2.js";import"./index.4313e517.js";import"./DateRangePicker.129f4a98.js";import"./index.0420192b.js";const c="_carbonChartPanel_19fe9_1";var b={carbonChartPanel:c};const p=()=>{const{t:n}=i(),e={title:n("\u80FD\u8017"),subTitle:n("(\u74E6\u7279/\u5C0F\u65F6)"),datePicker:!0,step:"1h",xAxis:{type:"time"},lines:[{name:n("energy consumption"),query:`((sum(label_replace(irate(container_cpu_usage_seconds_total{container!=""}[5m]), "node", "$1", "instance",  "(^[^:]+)") * on (node) group_left() max(kube_node_labels{label_beta_kubernetes_io_instance_type!~"eklet", label_node_kubernetes_io_instance_type!~"eklet"}) by (node))
/
